...
import { productChangeImg,productChangeSubImg } from '../../Store/reducers/product.reducer/product.reducer';
import "./CategoryProducts.style.scss"
function CategoryProducts() {

    let {category_name }= useParams<{category_name:string}>();
    const {productsCategory,loading,error} = useSelector((state:RootState)=>state.productsItems);
